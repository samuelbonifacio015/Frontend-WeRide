...
export class ReportProblemModal {
  ...
  categories: ProblemCategory[] = [
    { key: 'mechanical', label: 'garage.reportProblem.categories.mechanical' },
    { key: 'tires', label: 'garage.reportProblem.categories.tires' },
    { key: 'gps', label: 'garage.reportProblem.categories.gps' },
    { key: 'battery', label: 'garage.reportProblem.categories.battery' },
    { key: 'lock', label: 'garage.reportProblem.categories.lock' },
    { key: 'other', label: 'garage.reportProblem.categories.other' }
  ];
